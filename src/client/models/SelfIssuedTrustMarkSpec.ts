...
/* eslint-disable */
/**
 * Specification for a self-issued trust mark. Used when the entity issues trust marks to itself. Self-issued trust marks always refresh automatically based on the configured lifetime.
 */
