...
export const mockTrustAnchors: TrustAnchor[] = [
  ...
  },
  {
    ...
    entityId: 'https://edugain.org/federation',
    description: 'Intermediate Authority for eduGAIN interfederation',
    type: 'intermediate',
    status: 'active',
    subordinateCount: 45,
...
export const mockEntities: Entity[] = [
  ...
  {
    id: 'ent-4',
    entityId: 'https://library-services.edu',
    displayName: 'Academic Library Services',
    entityTypes: ['openid_relying_party'],
    trustAnchorId: 'ta-2',
    trustAnchorName: 'eduGAIN Interfederation',
    status: 'active',
    organizationName: 'Academic Library Consortium',
